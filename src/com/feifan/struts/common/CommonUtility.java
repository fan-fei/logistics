package com.feifan.struts.common;
...
public class CommonUtility {
	...
	public static boolean isTelephone(String telephone) {
		char charArray[] = telephone.trim().toCharArray();
		if (charArray.length != 11 && charArray.length != 12) {
			return false;
		}
	...
	public static boolean isUsername(String username) {
		if (!username.matches("[[\\u4E00-\\u9FA5]||\\p{Alnum}||_]+")) {
			return false;
		}
		return true;
	}
	...
	// 长度是否正确
	public static boolean isLengthOK(String str, int start, int end) {
	...
	public static void main(String[] args) {
		String identifycode = "1113333111234123515164017";
